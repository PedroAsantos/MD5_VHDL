...
-- Date        : Mon Jul  9 11:30:23 2018
-- Host        : Miguel running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               C:/Users/Miguel/Desktop/CR/CR_Project/maisque1Bloco/StreamPopCount/StreamPopCount.srcs/sources_1/bd/design_1/ip/design_1_StreamCopIPCore_0_0/design_1_StreamCopIPCore_0_0_sim_netlist.vhdl
...
entity design_1_StreamCopIPCore_0_0_StreamCopIPCore_v1_0_S00_AXIS is
  port (
    ...
    s_enable_reg_1 : out STD_LOGIC;
    s_enable_reg_2 : out STD_LOGIC;
    s00_axis_tready : out STD_LOGIC;
    s00_axis_aclk : in STD_LOGIC;
    s_enable_reg_3 : in STD_LOGIC;
...
architecture STRUCTURE of design_1_StreamCopIPCore_0_0_StreamCopIPCore_v1_0_S00_AXIS is
  ...
  signal \^s_enable_reg_1\ : STD_LOGIC;
  signal \^s_enable_reg_2\ : STD_LOGIC;
  signal \^tempfinished\ : STD_LOGIC;
  signal \NLW_s_counter_reg[31]_i_6_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal \NLW_s_counter_reg[31]_i_6_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \s_counter[10]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \s_counter[11]_i_1\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \s_counter[18]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \s_counter[19]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \s_counter[1]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \s_counter[20]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \s_counter[21]_i_1\ : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \s_counter[24]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \s_counter[25]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \s_counter[26]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \s_counter[27]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \s_counter[28]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \s_counter[29]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \s_counter[2]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \s_counter[30]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \s_counter[3]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \s_counter[4]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \s_counter[5]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \s_counter[6]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \s_counter[7]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \s_counter[8]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \s_counter[9]_i_1\ : label is "soft_lutpair3";
begin
...
\M[63]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \s_counter[31]_i_8_n_0\,
      I2 => \s_counter[31]_i_9_n_0\,
      I3 => \s_counter[31]_i_10_n_0\,
...
\s_counter[31]_i_11\: unisim.vcomponents.LUT6
    generic map(
...
\s_counter[31]_i_12\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\s_counter[31]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"E0"
    )
        port map (
...
\s_counter_reg[31]_i_6\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 2) => \NLW_s_counter_reg[31]_i_6_CO_UNCONNECTED\(3 downto 2),
      CO(1) => \s_counter_reg[31]_i_6_n_2\,
      CO(0) => \s_counter_reg[31]_i_6_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3) => \NLW_s_counter_reg[31]_i_6_O_UNCONNECTED\(3),
...
architecture STRUCTURE of design_1_StreamCopIPCore_0_0_StreamCopIPCore_v1_0 is
  signal StreamCopIPCore_v1_0_S00_AXIS_inst_n_131 : STD_LOGIC;
  signal StreamCopIPCore_v1_0_S00_AXIS_inst_n_132 : STD_LOGIC;
...
StreamCopIPCore_v1_0_S00_AXIS_inst: entity work.design_1_StreamCopIPCore_0_0_StreamCopIPCore_v1_0_S00_AXIS
     port map (
      ...
      s_enable_reg_0 => StreamCopIPCore_v1_0_S00_AXIS_inst_n_2,
      s_enable_reg_1 => StreamCopIPCore_v1_0_S00_AXIS_inst_n_131,
      s_enable_reg_2 => StreamCopIPCore_v1_0_S00_AXIS_inst_n_132,
      s_enable_reg_3 => tempFinished_i_1_n_0,
      tempFinished => tempFinished
    );
tempFinished_i_1: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => StreamCopIPCore_v1_0_S00_AXIS_inst_n_132,
      I4 => StreamCopIPCore_v1_0_S00_AXIS_inst_n_131,
      I5 => tempFinished,
