...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_StreamCopIPCore_v1_0_S00_AXIS is
  ...
  signal blockCounter_reg : STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  signal s_Tempreset : STD_LOGIC;
  signal s_Tempreset_i_1_n_0 : STD_LOGIC;
  ...
  signal NLW_s_enable_reg_i_3_CO_UNCONNECTED : STD_LOGIC_VECTOR ( 3 to 3 );
  ...
  attribute SOFT_HLUTNM of \currentState[2]_i_2\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of \i[6]_i_3\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \ledsOut_reg[15]_i_1\ : label is "soft_lutpair0";
...
\currentState[0]_i_10\: unisim.vcomponents.LUT6
    generic map(
...
\currentState[0]_i_11\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
...
\currentState[0]_i_12\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
...
\currentState[0]_i_13\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
...
\currentState[0]_i_8\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
...
s_Tempreset_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FE80"
    )
        port map (
...
s_Tempreset_reg: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
s_enable_reg_i_3: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3) => NLW_s_enable_reg_i_3_CO_UNCONNECTED(3),
